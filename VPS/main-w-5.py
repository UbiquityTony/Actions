...
try:
    USER_ID_W_5 = os.environ['USER_ID_W_5']
except:
    # 本地调试用
    USER_ID_W_5 = ''

try:
    PASS_WD_W_5 = os.environ['PASS_WD_W_5']
except:
    # 本地调试用
    PASS_WD_W_5 = ''
...
def login():
    ...
    print('- fill user id')
    if USER_ID_W_5 == '':
        print('*** USER_ID_W_5 is empty ***')
        kill_browser()
    else:
        write(USER_ID_W_5, into=S('@username'))
    print('- fill password')
    if PASS_WD_W_5 == '':
        print('*** PASS_WD_W_5 is empty ***')
        kill_browser()
    else:
        write(PASS_WD_W_5, into=S('@password'))
